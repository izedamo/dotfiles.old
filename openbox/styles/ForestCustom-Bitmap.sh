...
change_dock() {
	cat > "$HOME"/.cache/plank.conf <<- _EOF_
		...
		dock-items=['thunar.dockitem', 'firefox.dockitem', 'alacritty.dockitem']
		hide-delay=0
...
set_wall 'wal_10.jpg'																		# WALLPAPER

change_bar 'forest-bitmap' 'Terminus:Medium:size=10;2' && "$polybar_path"/launch.sh		# STYLE | FONT
...
obconfig 'Adapta-Nokto' 'LIMC' 'Terminus' '9' && openbox --reconfigure					# THEME | LAYOUT | FONT |SIZE
