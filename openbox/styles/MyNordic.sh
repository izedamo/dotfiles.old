...
#set_wall 'wal_7.jpg'																	# WALLPAPER

change_bar 'mynordic' 'Iosevka Nerd Font:size=10;3' && "$polybar_path"/launch.sh		# STYLE | FONT

## Change colors in funct (ROFI)
change_rofi 'mynordic' 'Iosevka 10' '0px' 'Numix-Apps'								# STYLE/DIR | FONT | BORDER | ICON
